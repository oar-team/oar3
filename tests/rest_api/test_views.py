...
def test_app_frontend_authentication(client):
    ...
    res = client.get(url_for('frontend.authentication', basic_user='user1', basic_password='user1'))
    print(res.json)
...
def test_app_frontend_authentication_wrong_passwd(client):
    ...
    res = client.get(url_for('frontend.authentication', basic_user='user1',
                             basic_password='wrong passwd'))
    print(res.json)
