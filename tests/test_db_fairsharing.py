from oar.lib import (db, Job, MoldableJobDescription, JobResourceDescription,
                     ...
                     AssignedResource, Accounting, get_logger)
...
def generate_accountings(nb_users = 5, t_window=24*36000, queue="default", project="default"):
    ...
    for u in range(nb_users):
        ...
        for i in range(nb_accounts): 
            ...
            accountings_a.append(( w_start, w_stop, project, user, queue, consumption+1000 ))
...
def test_db_fairsharing():
    ...
    for i,user in enumerate(users):
        insert_job(job_user="zozo" + user, res = [ (60, [('resource_id=4', "")]) ], properties="")
