...
class AssignedResource(db.Model):
    ...
    moldable_job_id = db.Column(db.Integer, primary_key=True, index=True, default="0")
    resource_id = db.Column(db.Integer, primary_key=True, default="0")
    assigned_resource_index = db.Column(db.String(7), index=True, default="CURRENT")
...
class EventLogHostname(db.Model):
    ...
    event_id = db.Column(db.Integer, primary_key=True, default="0")
    hostname = db.Column(db.String(255), primary_key=True, index=True, default="")
...
class FragJob(db.Model):
    ...
    id = db.Column('frag_id_job', db.Integer, primary_key=True, default="0")
...
class GanttJobsPrediction(db.Model):
    ...
    moldable_job_id = db.Column(db.Integer, primary_key=True, default="0")
...
class JobDependency(db.Model):
    ...
    job_id = db.Column(db.Integer, primary_key=True, index=True, default="0")
    job_id_required = db.Column(db.Integer, primary_key=True, default="0")
    job_dependency_index = db.Column(db.String(7), index=True, default="CURRENT")


class JobResourceDescription(db.Model):
    __tablename__ = 'job_resource_descriptions'

    res_job_group_id = db.Column(db.Integer, primary_key=True, index=True, default="0")
    res_job_resource_type = db.Column(db.String(255), primary_key=True, default="")
    res_job_value = db.Column(db.Integer, default="0")
    res_job_order = db.Column(db.Integer, primary_key=True, default="0")
    res_job_index = db.Column(db.String(7), index=True, default="CURRENT")


class JobResourceGroup(db.Model):
    __tablename__ = 'job_resource_groups'

    res_group_id = db.Column(db.BigInteger, primary_key=True)
    res_group_moldable_id = db.Column(db.Integer, index=True, default="0")
    res_group_property = db.Column(db.Text)
    res_group_index = db.Column(db.String(7), index=True, default="CURRENT")
...
class MoldableJobDescription(db.Model):
    ...
    job_id = db.Column('moldable_job_id', db.Integer, index=True, default="0")
    walltime = db.Column('moldable_walltime', db.Integer, default="0")
    index = db.Column('moldable_index', db.String(7), index=True, default="CURRENT")
...
class ResourceLog(db.Model):
    ...
    resource_id = db.Column(db.Integer, index=True, default="0")
