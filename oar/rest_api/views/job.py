...
@app.args({'resource': Arg([str]),
           ...
           'queue': Arg(str),
           'property': Arg(str, dest='properties'), #TODO add SQL sanatization ? (clause Where)
           'reservation': Arg(str),
           ...
           'hold': Arg(bool)})
@app.need_authentication()
def submit(resource, command, workdir, param_file, array, queue, properties, reservation,
           checkpoint, signal, types, directory, project, name, dependencies, notify, resubmit,
