...
class Hulot(object):
    ...
    def __init__(self):
        ...
        self.hulot_status_dump_name = config['OAR_RUNTIME_DIRECTORY'] + 'hulot_status.dump'
    ...
    def run(self, loop=True):
        ...
        while True:
            ...
            for properties in keepalive.keys():
                ...
                logger.debug('current_idle('+ properties + ') => ' +\
                ...
                wakeable_nodes = [n for n in keep_nodes if (n not in occupied_nodes) and (n not in idle_nodes)]
