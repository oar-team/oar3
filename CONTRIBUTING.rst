...
Python OAR RESTful API could always use more documentation, whether as part of the
official Python OAR RESTful API docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `oar-rest-api` for local development.
...
To run a subset of tests::
    ...
    $ py.test tests/test_oar_rest_api.py
